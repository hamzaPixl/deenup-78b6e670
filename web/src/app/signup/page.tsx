  ...
  return (
    <main style={{ maxWidth: 400, margin: '4rem auto', padding: '2rem', background: 'white', borderRadius: 12, boxShadow: '0 4px 24px rgba(0,0,0,0.08)' }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        <div>
          <label htmlFor="displayName" style={{ display: 'block', marginBottom: 4, fontWeight: 600 }}>Nom d&apos;affichage</label>
          <input
            id="displayName"
      ...
      <p style={{ marginTop: '1rem', textAlign: 'center', fontSize: '0.875rem' }}>
        Déjà un compte ?{' '}
        <Link href="/login" style={{ color: '#16a34a', fontWeight: 600 }}>Se connecter</Link>
      </p>
    </main>
  );
}
